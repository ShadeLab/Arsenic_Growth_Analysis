...
#remove repeat isolates
results=results[!(results$TestId=="I2702"),]
results=results[!(results$TestId=="I2718"),]
results=results[!(results$TestId=="I2720"),]
results=results[!(results$TestId=="I2746"),]
