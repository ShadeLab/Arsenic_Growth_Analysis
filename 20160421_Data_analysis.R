...
#read in raw data
data=data.frame(read.table("20160421_01_AsV_MIC_I2727,47,A2705.asc"), row.names=TRUE)
...
neg0=data.frame(data[,12])
neg0=data.frame(rep(neg0, 12))
neg10=data.frame(data[,24])
neg10=data.frame(rep(neg10, 12))
neg50=data.frame(data[,36])
neg50=data.frame(rep(neg50, 12))
neg100=data.frame(data[,48])
neg100=data.frame(rep(neg100, 12))
neg150=data.frame(data[,60])
neg150=data.frame(rep(neg150, 12))
neg200=data.frame(data[,72])
neg200=data.frame(rep(neg200, 9))
neg200=data.frame(cbind(neg200,data[,12],data[,48]),data[,72])
neg250=data.frame(data[,84])
neg250=data.frame(rep(neg250,9))
neg250=data.frame(cbind(neg250,data[,24],data[,60],data[,84]))
neg300=data.frame(data[,96])
neg300=data.frame(rep(neg300,9))
neg300=data.frame(cbind(neg300,data[,36],data[,12],data[,96]))
...
#read in platemap
platemap=read.csv("20160421_Platemap_High_MIC.csv")
...
#save results table
write.csv(results, "20160421_results")
...
reps=data.frame(read.table("20160421_replicates.csv", header=TRUE))
mu=cbind(mu, reps)
