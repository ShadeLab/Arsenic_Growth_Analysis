...
#read in raw data
data=data.frame(read.table("20160501_01_AsV_MIC_A05,16,35,I48.asc"), row.names=TRUE)
...
#read in platemap
platemap=read.csv("20160501_Platemap_High_MIC.csv")
...
#save results table
write.csv(results, "20160501_results")
